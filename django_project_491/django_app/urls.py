...
urlpatterns = [
    ...
    path('upvote_question/<int:question_id>/', question_views.upvote_question, name='upvote_question'),
    path('downvote_question/<int:question_id>/', question_views.downvote_question, name='downvote_question'),
