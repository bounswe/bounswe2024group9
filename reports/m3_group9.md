...
| Fatih | Question Detail Page in web| Completed |Create layouts and connect endpoints for editing and deleting Questions, Comment creation, editing, marking answers etc. |
| Fatih | Discussion Page in web| Completed | Integrating correct label structure and necessary endpoints. |
